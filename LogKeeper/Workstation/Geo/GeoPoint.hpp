...
public:
   ...
   */
  constexpr
  GeoPoint(const Angle longitude, const Angle latitude)
   ...
   * @param other The remote point
   * @return The distance from here to the other point in meters.
   */
  gcc_pure
   ...
   * @return True if this point is further left (or if equal, lower) than
   *         the other
   */
  gcc_pure
