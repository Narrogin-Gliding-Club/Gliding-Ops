...
#ifndef BROKEN_TIME_HPP
#define BROKEN_TIME_HPP
...
struct BrokenTime
  ...
  constexpr
  BrokenTime(unsigned hour, unsigned minute, unsigned second=0)
  ...
  unsigned GetMinuteOfDay() const
    {
    return this->hour * 60u + this->minute;
    }
