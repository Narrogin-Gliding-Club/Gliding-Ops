...
set(ARDUINO_BASE "${Glider-Ops_SOURCE_DIR}/LogKeeper/Arduino")
set(CMAKE_CXX_FLAGS
    "-Wall -fno-exceptions -ffunction-sections -fdata-sections -std=gnu++11 -mmcu=atmega32u4 -DF_CPU=16000000L -MMD -DUSB_VID=0x2341 -DUSB_PID=0x8036 -DARDUINO=105 -D__PROG_TYPES_COMPAT__ -I./ -I/usr/share/arduino/libraries/EEPROM -I/usr/share/arduino/libraries/FastSerial -I/usr/share/arduino/libraries/SPI -I/usr/share/arduino/libraries/Wire -I/usr/share/arduino/libraries/Wire/utility -I/usr/share/arduino/hardware/arduino/cores/arduino -I/usr/share/arduino/hardware/arduino/variants/leonardo -I${ARDUINO_BASE}/lib/MsTimer2 -I${ARDUINO_BASE}/lib/i2cdevlib/Arduino/I2Cdev -I${ARDUINO_BASE}/lib/Low-Power -I${ARDUINO_BASE}/lib/WSWireLib/Library/WSWire")
